...
import { deletePostFromCache, getPostsFromCache, getSinglePostFromCache, getUserPostsFromCache, savePostsToRedisCache, updatePostInRedisCache, updateSinglePostPropInRedisCache } from '@redis/post-cache';
...
describe('PostCache', () => {
  ...
  describe('updatePostInRedisCache', () => {
    it('should update post', async () => {
      postMockData._id = '6027f77087c9d9ccb1555268';
  ...
  describe('updateSinglePostPropInRedisCache', () => {
    it('should update post reactions', async () => {
      await savePostsToRedisCache('6027f77087c9d9ccb1555268', 123, postMockData);
      await expect(updateSinglePostPropInRedisCache('6027f77087c9d9ccb1555268', 'reactions', JSON.stringify([{ type: 'love', value: 2 }]))).resolves.toBeUndefined();
    });
  });
